/**
 * VENDORED: qrcode-generator v2.0.4 — dist/qrcode.mjs, unmodified below this
 * header. (c) Kazuhiko Arase, MIT License.
 * https://github.com/kazuhikoarase/qrcode-generator
 *
 * Vendored (S15 U8) so the pairing QR renders fully offline — no CDN, no
 * network fetch, license-compatible (MIT). Verified byte-identical to the npm
 * package by packages/terrace-ui/test/qr.test.ts, which also proves the SVG
 * encodes the exact invite key.
 */
//---------------------------------------------------------------------
//
